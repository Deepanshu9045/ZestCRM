        ...
        <div className="min-h-screen bg-white dark:bg-black text-gray-900 dark:text-gray-100 font-sans">
            <div className="max-w-4xl mx-auto px-6 py-24">
                ...
                <div className="prose prose-lg dark:prose-invert">
                    ...
                    <p>
                        We use the information to provide, operate, and maintain our website, improve, personalize, and expand our website, understand and analyze how you use our website, and develop new products, services, features, and functionality.
                    </p>
                    <h3>3. Security</h3>
                    <p>
